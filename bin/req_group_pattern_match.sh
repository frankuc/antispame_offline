...
doas spark-submit \
  ...
  --class "group.GroupPatternMatchExecutor" \
  --files "./conf/req_group4.xml" \
  $JAR \
  --date $DATE \
  --strategy_date "20230525" \
  --group-config "req_group4.xml" \
  --group_name "REQ_GROUP_DEVICE_RESOURCE_V4"
